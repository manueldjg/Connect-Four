$(document).ready(function() {
    ...
    config.blackPlayerName = prompt('Please enter the first player\'s name!', config.blackPlayerName) || config.blackPlayerName;
    config.redPlayerName = prompt('Please enter the first player\'s name!', config.redPlayerName) || config.redPlayerName;
